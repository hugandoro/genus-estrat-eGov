    ...
    <!-- <div class="col-md-8 col-md-offset-2"> -->
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="pull-left"><h3>Plan de Desarrollo | <b>Plan de Accion 2022</b></h3></div>
          <div class="pull-right">

            <!-- Formulario para filtro de consulta por SECRETARIAS -->
            <form method="GET" action="{{ url('/planaccionlistar2022') }}" role="form" enctype="multipart/form-data">
