    ...
    <!-- <div class="col-md-8 col-md-offset-2"> -->
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="pull-left"><h3>Plan de Desarrollo | <b>CONSTRUCCION Plan de Accion 2023</b></h3></div>
          <div class="pull-right">

            <!-- Formulario para filtro de consulta por SECRETARIAS -->
            <form method="GET" action="{{ url('/planaccionconstruir2023') }}" role="form" enctype="multipart/form-data">
                        ...
                        @foreach($medicionIndicador as $indicador) 
                          @if($indicador->nivel4_id == $Nivel4->id)
                            ...
                            @foreach($planIndicativo as $indicativo) 
                              @if(($indicativo->indicador_id == $indicador->id) && ($indicativo->vigencia_id == '15')) <!-- *** CUIDADO *** CON EL CODIGO SEGUN LA VIGENCIA -->
                            ...
                            <!-- Busca EL REZAGO 2022 PLAN INDICATIVO relacionado con el INDICADOR -->
                            @foreach($planIndicativoRezago2022 as $indicativoRezago) 
              ...
              <tr>
                <td>
                  <div class="pull-right">
                    ...
                    <a href="{{ url('/planaccionconstruir2023?filtroSecretaria=' . $aux)  }}"> <button type="submit" class="btn btn-warning"><span class="glyphicon glyphicon-list"></span> Volver al listado</button></a>
                  </div>
                </td>
              </tr>
