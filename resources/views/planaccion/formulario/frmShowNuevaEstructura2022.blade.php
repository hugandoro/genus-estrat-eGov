<!-- Vista de formulario completo modo SOLO LECTURA ( SHOW ) para la nueva estructura de PLAN DE ACCION vigente DESDE 2022 en adelante -->
			...
			<section class="panel"> 
				<div class="panel-body">
						...
						<div class="form-group">
							...
							<div>
								<input readonly value="{{ $planaccion->descripcion }}" class="form-control" placeholder="Breve desripcion de la accion..." required="required" name="descripcion" type="text" id="descripcion"> 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div>
								<input readonly value="{{ $planaccion->kpi }}" class="form-control" placeholder="Unidad de medida de rendimiento (Vacunas, proyectos, reuniones, kilometros pavimentados, etc)..." required="required" name="kpi" type="text" id="kpi"> 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div>
								<input readonly value="{{ $planaccion->objetivo }}" class="form-control" placeholder="Valor a realizar respecto al KPI..." required="required" name="objetivo" type="number" min="1" id="objetivo"> 
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div>
								<input readonly value="{{ $planaccion->ponderacion * 100 }}" class="form-control" placeholder="Indique el peso porcentual asignado a esta accion..." required="required" name="ponderacion" type="number" min="0" max="100" id="ponderacion"> 
							</div>
						</div>
						...
						<div class="form-group" style="background-color: #C9F7C1;">
							...
							<div>
								<select readonly class="form-control" name="n2022_converge_politica_publica">
						...
						<div class="form-group" style="background-color: #C9F7C1;">
							...
							<div>
								<select readonly class="form-control" name="n2022_converge_pgirs">
						...
						<div class="form-group" style="background-color: #C9F7C1;">
							...
							<div>
								<select readonly class="form-control" name="n2022_converge_gestion_riesgo">
						...
						<div class="form-group" style="background-color: #C9F7C1;">
							...
							<div>
								<select readonly class="form-control" name="n2022_converge_mipg">
						...
						<div class="form-group" style="background-color: #C9F7C1;">
							...
							<div>
								<select readonly class="form-control" name="n2022_ods">
						...
						<div class="form-group col-md-6">
							...
							<div>
								<input readonly value="{{ $planaccion->n2022_recursos }}" class="form-control" placeholder="Valor en $ asignado..." required="required" name="n2022_recursos" type="text" min="0" id="number" style="font-size: 20px;"> 
							</div>
						</div>
						...
						<div class="form-group col-md-6">
							...
							<div>
								<select readonly class="form-control" name="n2022_fuente">
						...
						<div class="form-group col-md-6">
							...
							<div>
								<input readonly value="{{ $planaccion->n2022_recursos2 }}" class="form-control" placeholder="Valor en $ asignado..." required="required" name="n2022_recursos2" type="text" min="0" id="number2" style="font-size: 20px;"> 
							</div>
						</div>
						...
						<div class="form-group col-md-6">
							...
							<div>
								<select readonly class="form-control" name="n2022_fuente2">
						...
						<div class="form-group col-md-6">
							...
							<div>
								<input readonly value="{{ $planaccion->n2022_recursos3 }}" class="form-control" placeholder="Valor en $ asignado..." required="required" name="n2022_recursos3" type="text" min="0" id="number3" style="font-size: 20px;"> 
							</div>
						</div>
						...
						<div class="form-group col-md-6">
							...
							<div>
								<select readonly class="form-control" name="n2022_fuente3">
						...
						<div class="form-group col-md-6">
							...
							<div>
								<input readonly value="{{ $planaccion->n2022_recursos4 }}" class="form-control" placeholder="Valor en $ asignado..." required="required" name="n2022_recursos4" type="text" min="0" id="number4" style="font-size: 20px;"> 
							</div>
						</div>
						...
						<div class="form-group col-md-6">
							...
							<div>
								<select readonly class="form-control" name="n2022_fuente4">
						...
						<div class="form-group">
							...
							<div>
								<select readonly class="form-control" name="n2022_codigo_fut">
						...
						<div class="form-group">
							...
							<div>
								<select readonly class="form-control" name="n2022_codigo_bpim">
						...
						<div class="form-group">
							...
							<div>
								<input readonly value="{{ $planaccion->n2022_producto_actividad_proyectos }}" class="form-control" placeholder="Producto o actividad..." required="required" name="n2022_producto_actividad_proyectos" type="text" id="n2022_producto_actividad_proyectos"> 
							</div>
						</div>
						...
						<div class="form-group col-md-3">
							...
							<div>
								<select readonly class="form-control" name="n2022_ccpet" >
						...
						<div class="form-group col-md-3">
							...
							<div>
								<select readonly class="form-control" name="n2022_ccpet2" >
									@foreach($ConvCcpetCodigo as $item)
						...
						<div class="form-group col-md-3">
							...
							<div>
								<select readonly class="form-control" name="n2022_ccpet3" >
									@foreach($ConvCcpetCodigo as $item)
						...
						<div class="form-group col-md-3">
							...
							<div>
								<select readonly class="form-control" name="n2022_ccpet4" >
									@foreach($ConvCcpetCodigo as $item)
						...
						<div class="form-group col-md-3">
							...
							<div>
								<select readonly class="form-control" name="n2022_cpc" >
						...
						<div class="form-group col-md-3">
							...
							<div>
								<select readonly class="form-control" name="n2022_cpc2" >
									@foreach($ConvCpcCodigo as $item)
						...
						<div class="form-group col-md-3">
							...
							<div>
								<select readonly class="form-control" name="n2022_cpc3" >
									@foreach($ConvCpcCodigo as $item)
						...
						<div class="form-group col-md-3">
							...
							<div>
								<select readonly class="form-control" name="n2022_cpc4" >
									@foreach($ConvCpcCodigo as $item)
						...
						<div class="form-group">
							...
							<div>
								<select readonly class="form-control" name="n2022_sector">
						...
						<div class="form-group">
							...
							<div>
								<select readonly class="form-control" name="n2022_proyecto_producto" >
						...
						<div class="form-group">
							...
							<div>
								<select readonly class="form-control" name="n2022_proyecto_indicador" >
									<!-- No almacena el Id, almacena el concatenado del campo "codigo" "-" "nombre" -->
