    ...
    <!-- <div class="col-md-8 col-md-offset-2"> -->
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="pull-left"><h3>Plan de Desarrollo | <b>Actividades (Metas) - Niveles de avance y ejecución 2023</b></h3></div>
          <div class="pull-right">

            <!-- Formulario para filtro de consulta por SECRETARIAS -->
            <form method="GET" action="{{ url('/plandesarrollonivel4listaravance2023') }}" role="form" enctype="multipart/form-data">
             ...
             <tbody>
                ...
                <td>
                  ...
                  <table id="mytable" class="table table-bordred table-striped">
                    <tbody>
                     ...
                     <!-- Inicia acumulador porcentaje de cumplimiento de los indicadores - Vigencia 2023 -->
                     @php $acumImpactoIndicador2023General = 0; @endphp
                          ...
                          <table id="mytable" class="table table-bordered table-dark">
                            ...
                            @foreach($medicionIndicador->where('nivel4_id',$Nivel4->id) as $indicador) 
                              {{-- @if($indicador->nivel4_id == $Nivel4->id) --}}
                                ...
                                @foreach($planIndicativo->where('indicador_id',$indicador->id)->where('vigencia_id','15') as $indicativo) 
                                  {{-- @if(($indicativo->indicador_id == $indicador->id) && ($indicativo->vigencia_id == '15')) --}}
                                    ...
                                    <tr>
                                      <td colspan="1"></td>
                                      <td colspan="4">Plan Accion -> Ponderados -> Acumulado 2023</td>
                                      <td colspan="1">{{ round(($acumProporcionalPonderadoAccion * 100),2) }} %</td>
                                    </tr>

                                    <tr>
                                      <td colspan="1"></td>
                                      <td colspan="4">Actividad (Meta) -> Impacto ponderado al indicador -> Objetivo 2023</td>
                                      @if($indicador->Medida->id == 2)
                                    ...
                                    <tr>
                                      ...
                                      <td colspan="4" style="background:rgb(104, 103, 187);color:#ffffff;">Actividad (Meta) -> Porcentaje ponderado cumplimiento -> Cuatrienio</td>
                                        ...
                                        <!-- Acumula a nivel GENERAL el nivel de avance de cada Actividad Nivel 4 (Vigencia 2022 -->
                                        @php $acumImpactoIndicador2023General = $acumImpactoIndicador2023General + ($indicador->porcentaje_realizado * 100); @endphp
                                    </tr>
              ...
              <tr>
                @if ($acumAccionesGeneral != 0)
                  <td><h1><b>{{ round(($acumImpactoKPIGeneral/$acumAccionesGeneral),2) }} %</b></h1><h4>Porcentaje promedio de cumplimiento | Plan de Accion 2023</h4></td>
                @else
                  <td><h1><b>0 %</b></h1><h4>Porcentaje promedio de cumplimiento | Plan de Accion 2023</h4></td>
                @endif
              </tr>
