    ...
    <!-- <div class="col-md-8 col-md-offset-2"> -->
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="pull-left"><h3>Plan de Desarrollo | <b>Actividades (Metas) - Niveles de avance y ejecución 2022</b></h3></div>
          <div class="pull-right">

            <!-- Formulario para filtro de consulta por SECRETARIAS -->
            <form method="GET" action="{{ url('/plandesarrollonivel4listaravance2022') }}" role="form" enctype="multipart/form-data">
             ...
             <tbody>
                ...
                <td>
                  ...
                  <table id="mytable" class="table table-bordred table-striped">
                    <tbody>
                     ...
                     <!-- Inicia acumulador porcentaje de cumplimiento de los indicadores - Vigencia 2022 -->
                     @php $acumImpactoIndicador2022General = 0; @endphp
                          ...
                          <table id="mytable" class="table table-bordered table-dark">
                            ...
                            @foreach($medicionIndicador->where('nivel4_id',$Nivel4->id) as $indicador) 
                              {{-- @if($indicador->nivel4_id == $Nivel4->id) --}}
                                ...
                                @foreach($planIndicativo->where('indicador_id',$indicador->id)->where('vigencia_id','14') as $indicativo) 
                                  {{-- @if(($indicativo->indicador_id == $indicador->id) && ($indicativo->vigencia_id == '14')) --}}
                                    ...
                                    <tr>
                                      <td colspan="1"></td>
                                      <td colspan="4">Plan Accion -> Ponderados -> Acumulado 2022</td>
                                      <td colspan="1">{{ round(($acumProporcionalPonderadoAccion * 100),2) }} %</td>
                                    </tr>

                                    <tr>
                                      <td colspan="1"></td>
                                      <td colspan="4">Actividad (Meta) -> Impacto ponderado al indicador -> Objetivo 2022</td>
                                      @if($indicador->Medida->id == 2)
                                    ...
                                    <tr>
                                      ...
                                      <td colspan="4" style="background:rgb(104, 103, 187);color:#ffffff;">Actividad (Meta) -> Porcentaje ponderado cumplimiento -> Cuatrienio</td>
                                        ...
                                        @php $acumImpactoIndicador2022General = $acumImpactoIndicador2022General + ($indicador->porcentaje_realizado * 100); @endphp
                                    </tr>
              ...
              <tr>
                @if ($acumAccionesGeneral != 0)
                  <td><h1><b>{{ round(($acumImpactoKPIGeneral/$acumAccionesGeneral),2) }} %</b></h1><h4>Porcentaje promedio de cumplimiento | Plan de Accion 2022</h4></td>
                @else
                  <td><h1><b>0 %</b></h1><h4>Porcentaje promedio de cumplimiento | Plan de Accion 2022</h4></td>
                @endif
              </tr>
