    ...
    <!-- <div class="col-md-8 col-md-offset-2"> -->
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="pull-left"><h3>Plan de Desarrollo | <b>Cronologico tareas reportadas en plataforma | 2023</b></h3></div>
                ...
                <td>
                  <h4><b>{{ $totalTareas }}</b> | Tareas registradas en el sistema
                    @if ((Auth::user()->hasRole('super')) || (Auth::user()->hasRole('admin')))
                      | <a href="{{ url('/tareaslistargeneralexcel2023') }}"><img src="{{ asset("images/iconos/excel.png") }}" alt="Estrategov" width="60px"></a>
                    @endif
                  </h4>
                </td>
              </tr>
