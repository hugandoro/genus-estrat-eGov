    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <div class="pull-left">
            <h3>Modelo integrado planeación y gestión MIPG | <b>Plan Acción 2022 - Reporte de tareas</b></h3>
          </div>
          <div class="pull-left">

            <!-- Formulario para filtro de consulta por SECRETARIAS -->
            <form method="GET" action="{{ url('/mipgplanaccionlistarreporte2022') }}" role="form" enctype="multipart/form-data">
                  ...
                  <table id="mytable" class="table table-bordred table-striped">
                    <tbody>
                      ...
                      @foreach($moduloMipgNivel4 as $Nivel4)
                        @if($Nivel4->vigencia_id == 14) <!-- Solo visualiza al usuario las acciones de la vigencia 2022 (Codigo 14) -->
