    ...
    <div class="col-md-10 col-md-offset-1">
      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <div class="pull-left"><h3>Modelo integrado planeación y gestión MIPG | <b>Plan Acción 2022</b></h3></div>
          <div class="pull-left">

            <!-- Formulario para filtro de consulta por SECRETARIAS -->
            <form method="GET" action="{{ url('/mipgplanaccionlistar2022') }}" role="form" enctype="multipart/form-data">
