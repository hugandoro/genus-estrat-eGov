    ...
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <div class="pull-right"><a class="btn btn-success" href="{{ route('ppdepartamental.create') }}" ><span class="glyphicon glyphicon-plus"></span>  Crear nuevo</a></div>
              ...
              <tr>
                ...
                <td>
                  <form action="{{ route('ppdepartamental.destroy',$politica->id) }}" method="POST" class="form-horizontal" role="form" onsubmit="return confirmarEliminar()">
                    ...
                    <a href="{{ route('ppdepartamental.edit',$politica->id) }}" class="btn btn-primary"><span class="glyphicon glyphicon-pencil"></span>  Editar</a>
