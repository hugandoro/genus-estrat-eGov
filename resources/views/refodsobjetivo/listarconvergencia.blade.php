    ...
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="pull-left"><h3>Plan de Desarrollo | <b>Convergencia con los ODS</b></h3></div>
          <div class="pull-right">

            <!-- Formulario para filtro de consulta por SECRETARIAS -->
            <form method="GET" action="{{ url('/odslistarconvergencia') }}" role="form" enctype="multipart/form-data">
                ...
                <tr>
                  <td>
                    <div class="form-group">
                      ...
                      <select class="form-control" name="filtroODS">
                        @foreach($refOdsObjetivo as $ods) 
                            @if((isset($_GET['filtroODS'])) && ($ods->id == $_GET['filtroODS']))
                              <option value={{ $ods->id }} selected>{{ $ods->nombre }}</option>
                            @else
          ...
          <div class="table-container">
            <table id="mytable" class="table table-bordred table-striped">
             <tbody>
              ...
              <tr>
                <td><h4><b>{{ count($convergenciaNivel4ODS) }}</b> | Registros encontrados</h4></td>
              </tr>
                ...
                <td>
                  ...
                  <table id="mytable" class="table table-bordred table-striped">
                    <tbody>
                     ...
                     @foreach($convergenciaNivel4ODS as $nivel4) 
                      <tr>
