    ...
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-default">
        <div class="panel-body">
          <div class="pull-left"><h3>Plan de Desarrollo | <b>Convergencia con las POLITICAS PUBLICAS MUNICIPALES</b></h3></div>
          <div class="pull-right">

            <!-- Formulario para filtro de consulta por SECRETARIAS -->
            <form method="GET" action="{{ url('/ppmunicipallistarconvergencia') }}" role="form" enctype="multipart/form-data">
                ...
                <tr>
                  <td>
                    <div class="form-group">
                      ...
                      <select class="form-control" name="filtroPPMunicipal">
                        @foreach($refMunicipalPolitica as $ppmunicipal) 
                            @if((isset($_GET['filtroPPMunicipal'])) && ($ppmunicipal->id == $_GET['filtroPPMunicipal']))
                              <option value={{ $ppmunicipal->id }} selected>{{ $ppmunicipal->nombre }}</option>
                            @else
                              <option value={{ $ppmunicipal->id }}>{{ $ppmunicipal->nombre }}</option>
                            @endif
                        @endforeach
                      </select>                  
          ...
          <div class="table-container">
            <table id="mytable" class="table table-bordred table-striped">
             <tbody>
              ...
              <tr>
                <td><h4><b>{{ count($convergenciaNivel4PPMunicipal) }}</b> | Registros encontrados</h4></td>
              </tr>
                ...
                <td>
                  ...
                  <table id="mytable" class="table table-bordred table-striped">
                    <tbody>
                     ...
                     @foreach($convergenciaNivel4PPMunicipal as $nivel4) 
                      <tr>
