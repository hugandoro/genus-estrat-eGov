...
class PlanAccionController extends Controller
{
    ...
    public function listarRegistros()
    {
        ...
        return view('planaccion.listarplanaccion', compact('planDesarrollo','planDesarrolloNivel4','medicionIndicador','planIndicativo','planAccion','entidadOficina','pagination'));
    }

    /**
     * Listar GLOBALMENTE todos los registros del nivel 4 ( Actividades o Metas ) - Para REPORTAR 
     * @return \Illuminate\Http\Response
     */
    public function listarRegistrosReporte()
    {
        $planDesarrollo = PlanDesarrollo::where('administracion_id', config('app.administracion'))->with('administracion')->get();
        ...
        return view('planaccion.listarplanaccionreporte', compact('planDesarrollo','planDesarrolloNivel4','medicionIndicador','planIndicativo','planAccion', 'tarea','entidadOficina','pagination'));
    }
